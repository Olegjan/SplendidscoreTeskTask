...
Assets/Scripts/
  ...
  AudioManager.ts      — звуки монетки, зіткнення, стрибка, підкату, зміни смуги
...
Плата — звʼязок з іменами в сцені: перейменування могло б вимкнути звук мовчки.
Тому `onAwake` звіряє сцену з enum і друкує, для яких подій звуку немає і які звуки
не мають події. Сам `play()` на невідому подію просто мовчить — гра не повинна падати
через неозвучену дію.
...
вирішує, чи озвучувати її. Напрямок залежностей при цьому не змінився — гравець
як і раніше нічого не знає про звук.

Перевірено в Preview: два свайпи вгору з інтервалом 120 мс дають один звук, а три
свайпи вліво поспіль — теж один (далі гравець упирається в край доріжки).
